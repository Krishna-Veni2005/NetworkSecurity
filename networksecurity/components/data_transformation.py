...
from networksecurity.constant.training_pipeline import TARGET_COLUMN,DATA_TRANSFORMATION_IMPUTED_PARAMS
...
class DataTransformation:
    ...
    def get_data_transformer_object(self)->Pipeline:
        ...
        try:
            imputer:KNNImputer=KNNImputer(**DATA_TRANSFORMATION_IMPUTED_PARAMS)
            logging.info(
                f"Initialise KNNImputer with {DATA_TRANSFORMATION_IMPUTED_PARAMS}"
            )
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            save_object(file_path=self.data_transformation_config.tranformed_object_file_path,obj=preprocessor_object)
