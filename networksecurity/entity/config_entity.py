...
class TrainingPipelineConfig:
    def __init__(self,timestamp=datetime.now()):
        ...
        self.artifact_dir = os.path.join(self.artifact_name,timestamp.strftime("%m%d%Y__%H%M%S"))
...
class DataTransformationConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.tranformed_object_file_path:str=os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR,
